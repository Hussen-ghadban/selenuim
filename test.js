...
(async function inspectPage() {
    ...
    try {
        ...
        // Wait until a specific element is visible to ensure the page has loaded
        // You can change this selector to any element that indicates the page is ready
        await driver.wait(until.elementIsVisible(driver.findElement(By.css('.movie-preview'))), 10000);

        // Take a screenshot of the page
        let screenshot = await driver.takeScreenshot();
        fs.writeFileSync('screenshot.png', Buffer.from(screenshot, 'base64'));

        // Extract and print outer HTML of elements with the class 'movie-preview'
